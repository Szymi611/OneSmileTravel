...
import com.travelmobileapp.viewmodel.RoomViewModel

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ChatRoomListScreen(
    roomViewModel: RoomViewModel = viewModel(), //roomViewModel is a variable that is being assigned an instance of RoomViewModel returned by the viewModel() function.
                        ...
                        Button(
                            onClick = {
                                if (name.isNotBlank()) {
                                    ...
                                    Log.d("ChatRoomListScreen", "Room created")
                                }
                            }
                        ) {
                            Text("Add")
